...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="肖天宇"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="13141309261"/>
	<input type="hidden" name="orderShipping.receiverState" value="北京"/>
	<input type="hidden" name="orderShipping.receiverCity" value="北京"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="海淀区区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="北京市海淀区BJFU" />
