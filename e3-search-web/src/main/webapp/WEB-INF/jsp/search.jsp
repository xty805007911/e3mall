    ...
    <div class="r-filter">
      <div class="f-sort">
        <div class="pagin">
         ...
         <a href="${pageContext.request.contextPath }/search.html?keyword=${query}&page=${page<=1?1:page-1}">上一页</a>&nbsp;&nbsp;&nbsp;
         <!--  <span class="next"> --><a href="${pageContext.request.contextPath }/search.html?keyword=${query}&page=${page==totalPages?page:page+1}">下一页</a><!-- </span>  -->     	</div>
